...
/**
 * Revolutionary 1976uk Website Management Dashboard
 * Complete control over all website content
 */

// Simple password protection
session_start();
$correct_password = '1976uk2025';
...
if (isset($_FILES['uploaded_image']) && $_FILES['uploaded_image']['error'] === UPLOAD_ERR_OK) {
    ...
    $new_filename = "image-{$timestamp}-{$safe_name}";
...
<head>
    ...
    <title>1976uk Website Management Dashboard</title>
...
<?php if ($current_section === 'dashboard'): ?>
    ...
    <div class="dashboard-container">
        <div class="dashboard-header">
            <h1>🎨 1976uk Website Management</h1>
        ...
        <div class="dashboard-grid">
            ...
            <div class="dashboard-card" onclick="window.open('?section=text_page', '_blank')">
                ...
                <p>Edit all text content, 1976uk statement, and narrative sections</p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="text_intro" rows="6"><?php echo htmlspecialchars($current_content['text_page']['intro_text'] ?? 'Welcome to my Creative Journey...'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="text_section_1_title" 
                                   value="<?php echo htmlspecialchars($current_content['text_page']['section_1_title'] ?? 'My Creative Philosophy'); ?>">
                        </div>
                        <div class="form-group">
